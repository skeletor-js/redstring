...
export function ClusterView() {
  ...
  const [selectedCluster, setSelectedCluster] = useState<ClusterSummary | null>(
    null
  );
          ...
          {error && (
            <div className="cluster-view-error">
              ...
              <div>
                ...
                <p className="cluster-view-error-message">{error.message}</p>
              </div>
            </div>
          )}
        </div>
        ...
        <>
          ...
          <div className="cluster-view-results-header">
            ...
            <button
              ...
              className="cluster-view-reconfigure"
            >
              ← New Analysis
            </button>
          </div>

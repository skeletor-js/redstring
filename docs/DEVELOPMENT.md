...
│   │   ├── casesApi.ts      # Cases endpoints
│   │   ├── clustersApi.ts   # Clustering endpoints
│   │   └── ...
...
│   │   ├── clusters.py      # POST /api/clusters/analyze, etc.
│   │   ├── setup.py         # POST /api/setup/initialize
│   │   └── ...
│   ├── services/            # Business logic
│   │   ├── query_builder.py # SQL query construction
│   │   ├── clustering.py    # Multi-factor similarity algorithm
│   │   └── ...
│   ├── models/              # Pydantic data models
│   │   ├── case.py          # Case DTO
│   │   ├── cluster.py       # Cluster DTO
│   │   └── ...
│   ├── database/            # Database layer
│   │   ├── connection.py    # Connection manager
│   │   ├── schema.py        # SQLite schema creation
│   │   ├── loader.py        # CSV data import
│   │   └── ...
│   ├── analysis/            # Analysis algorithms
│   │   ├── similarity.py    # Multi-factor similarity scoring
│   │   ├── geographic.py    # Haversine distance, location utils
│   │   └── ...
